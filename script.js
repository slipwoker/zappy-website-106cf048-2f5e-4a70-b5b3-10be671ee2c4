document.addEventListener('DOMContentLoaded', function () {
        ...
        fetch(action, {
          ...
          .then(function () {
            ...
            successMsg.textContent =
              contactForm.dataset.successMessage || 'Your message has been sent successfully!';
          })
          .catch(function () {
            let errorMsg = contactForm.querySelector('.submit-error');
            if (!errorMsg) {
            ...
            errorMsg.textContent =
              contactForm.dataset.errorMessage || 'Something went wrong. Please try again.';
          })
          .finally(function () {
            if (submitBtn) {
  ...
  const OBSERVED_SELECTORS = '.fade-in, [data-animate], .animate-on-scroll';
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "AL חנות ורודה והכל פרחים ופפיונים משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '106cf048-2f5e-4a70-b5b3-10be671ee2c4',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '106cf048-2f5e-4a70-b5b3-10be671ee2c4';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '106cf048-2f5e-4a70-b5b3-10be671ee2c4';
